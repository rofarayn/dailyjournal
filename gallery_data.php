<table class="table table-hover">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th class="w-20">Tanggal Upload</th>
                        <th class="w-15">Uploader</th>
                    ...
                    $hasil = $conn->query($sql);
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    // Cek jika kolom gambar tidak kosong dan file ada di folder img/
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="post" action="" enctype="multipart/form-data">
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            <label for="formGroupExampleInput" class="form-label">Uploader</label>
                                                            <input type="hidden" name="id" value="<?= $row["id"] ?>">
                                                            <input type="text" class="form-control" name="uploader" placeholder="Tuliskan Judul Artikel" value="<?= $row["uploader"] ?>" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label">Tanggal</label>
                                                            <input type="date" class="form-control" name="yanggal" required>
                                                        </div>
                                                        <div class="mb-3">
